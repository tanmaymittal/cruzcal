...
module.exports = (db) => ({
   ...
   * @returns {Promise<Model>} newly created row
   */
  ...
  /**
   * @returns {Promise<Model[]>} All rows in CourseInfo table
   */
  getAllCourses: async () => await db.models.CourseInfo.findAll(),
  /**
   * @returns {Promise<Model[]>} All rows in Term table
   */
  getAllTerms: async () => await db.models.Term.findAll(),
  /**
   * @param {number} code - term code for desired term
   * @returns {Promise<Model|null>} Specified term or null if it doesn't exist.
   */
   ...
   * @returns {Promise<Model|null>} Specified course or null if it doesn't exist.
   */
